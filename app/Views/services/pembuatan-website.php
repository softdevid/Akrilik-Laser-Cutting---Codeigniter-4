...
<div class="jumbotron bg-cover text-white"
    ...
    <div class="container">
        ...
        <p class="lead">Website menjadi fasilitas sangat penting untuk pemasaran dan scale up bisnis di era digital ini.
            Miliki sekarang!</p>
    </div>
</div>
<div class="container">
        ...
        <div class="col-md-3 p-3">
            <div class="container">
                <div class="row text-center">
                    <div class="services-category active pt-2">
                        <a href="#" class="nav-link">
                            <h5>Advertising</h5></i>
                        </a>
                    </div>
                    <div class="services-category pt-2">
                        <a href="#" class="nav-link">
                            <h5>All</h5></i>
                        </a>
                    </div>
